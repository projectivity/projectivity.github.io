...
function optimizeYouTubeEmbeds() {
    ...
    for ( var i = 0; i < frames.length; i++ ) {
        ...
        if ( frames[ i ].src && frames[ i ].src.length > 0 && frames[ i ].src.match(/http(s)?:\/\/www\.youtube\.com/)) {
            ...
            var code='<a href="#"  onclick="LoadYoutubeVidOnPreviewClick(\''+id+'\');return false;" id="skipser-youtubevid-'+id+'" style="postition:relative"><table class=“play button”><tbody><tr><td><img src=“/images/playbutton.png”></img></td></tr></tbody></table><img class="img thumb" src="http://i.ytimg.com/vi/'+id+'/hqdefault.jpg" style="width:'+w+'px; height:'+h+'px;" /></a>';
